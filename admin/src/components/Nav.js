...
export default function Nav({ show }) {
    const inactiveLink = 'flex gap-1 p-1 pl-4 pr-8 py-4';
    const activeLink = inactiveLink + ' bg-blue-100 text-blue-700 rounded-l-md';
    ...
    return (
        <aside className={(show ? 'left-0' : '-left-full') + " top-0 text-white pl-4 ml-2 pt-20 overflow-hidden fixed w-full bg-indigo-800 h-screen md:static md:w-auto transition-all"}>
            <nav className="flex flex-col gap-2 text-xl overflow-y-hidden">
